...
import 'package:sampleproject/screens/destination_screen.dart';
                          ...
                          Positioned(
                            ...
                            Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow:[BoxShadow(color: Colors.black26,offset: Offset(0.0,2),
                                blurRadius: 20.0
                               )]
                               ),
                               child: Stack(
                                 children: <Widget>[
                                  Hero(
                                      tag: destination.imageUrl,
                                       child: ClipRRect(
                                       borderRadius: BorderRadius.circular(20.0),
                                       child: Image(width:180.0,height: 180.0,
